...
<body class="font-sans text-gray-900 dark:text-gray-100 antialiased bg-white dark:bg-gray-800 selection:bg-gray-900 selection:text-white">
    <div class="min-h-screen grid lg:grid-cols-2">
        ...
        <!-- Right Column (Form) -->
        <div class="flex flex-col justify-center px-8 sm:px-12 lg:px-16 py-12 bg-white dark:bg-gray-800">
            <div class="w-full max-w-lg mx-auto">
                ...
                <!-- Greeting -->
                <h2 class="text-3xl font-bold mb-6 text-slate-900 dark:text-slate-100 tracking-tight" style="font-family: 'Ping', sans-serif;">
                    إنشاء حساب جديد
                </h2>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input id="name"
                                   ...
                                   class="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-gray-700 focus:outline-none focus:ring-2 dark:bg-gray-900 dark:text-white focus:ring-black focus:border-transparent transition duration-200 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 text-sm shadow-sm dark:shadow-none" />
                            <x-input-error :messages="$errors->get('name')" class="mt-1" />
                        </div>

                        <div class="space-y-1.5">
                            <label for="clinic_code" class="block text-sm font-medium text-slate-700 dark:text-slate-300">
                                {{ __('اسم العيادة') }}
                            </label>
                        ...
                        <div class="space-y-1.5">
                            <label for="gender" class="block text-sm font-medium text-slate-700 dark:text-slate-300">
                                {{ __('الجنس') }}
                            </label>
                            <select id="gender"
                                    name="gender"
                                    required
                                    class="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-gray-700 focus:outline-none focus:ring-2 dark:bg-gray-900 dark:text-white focus:ring-black focus:border-transparent transition duration-200 text-slate-900 dark:text-slate-100 text-sm shadow-sm dark:shadow-none bg-white dark:bg-gray-800">
                    ...
                    <div>
                        <button type="submit"
                                class="w-full bg-black text-white font-medium py-3 px-6 rounded-2xl hover:bg-slate-800 active:scale-[0.99] transition duration-200 text-center shadow-lg dark:shadow-none shadow-black/5 flex items-center justify-center text-base">
                            إنشاء حساب
                        </button>
                    </div>
                    ...
                    <div class="text-center mt-5">
                        <a href="{{ route('login') }}" class="text-sm text-slate-600 dark:text-slate-400 hover:text-black font-medium transition">
