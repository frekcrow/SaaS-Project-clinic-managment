...
<html lang="{{ app()->getLocale() }}" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
    ...
    <body class="font-sans antialiased bg-slate-50 text-slate-800">
        <x-dynamic-island />
        <div x-data="{ expanded: false }" class="flex h-screen bg-gray-50 overflow-hidden">
            ...
            <!-- Main Content Area -->
            <div class="flex-1 flex flex-col min-w-0 transition-all duration-300 h-screen overflow-hidden" :class="expanded ? 'md:ms-44' : 'md:ms-20'">
                <!-- Top Header (Floating) -->
