...
<html lang="{{ app()->getLocale() }}" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
    ...
    <body class="font-sans antialiased bg-slate-50 text-slate-800">
        ...
        <div class="min-h-screen flex relative overflow-hidden">
            ...
            >
                <!-- Toggle Button -->
                <button @click="isCollapsed = !isCollapsed" class="absolute -start-3 top-6 bg-white border border-slate-200 text-slate-500 rounded-full p-1 shadow-sm hover:bg-slate-50 transition-colors z-50 flex items-center justify-center">
                ...
                <nav class="flex-1 px-3 py-4 space-y-2 overflow-y-auto overflow-x-hidden">
                    <a href="{{ route('dashboard') }}" class="flex items-center px-3 py-3 text-slate-600 hover:bg-slate-100/50 hover:text-indigo-600 rounded-2xl transition-all duration-200 group {{ request()->routeIs('dashboard') ? 'bg-indigo-50 text-indigo-600' : '' }}">
                        ...
                        <span x-show="!isCollapsed" x-transition.opacity.duration.300ms class="me-2 text-base font-medium whitespace-nowrap">{{ __('الرئيسية') }}</span>
                    </a>
                    ...
                    <a href="{{ route('surgeries.index') }}" class="flex items-center px-3 py-3 text-slate-600 hover:bg-slate-100/50 hover:text-indigo-600 rounded-2xl transition-all duration-200 group {{ request()->routeIs('surgeries.*') ? 'bg-indigo-50 text-indigo-600' : '' }}">
                        ...
                        <span x-show="!isCollapsed" x-transition.opacity.duration.300ms class="me-2 text-base font-medium whitespace-nowrap">{{ __('العمليات') }}</span>
                    </a>
                    ...
                    <a href="{{ route('patients.index') }}" class="flex items-center px-3 py-3 text-slate-600 hover:bg-slate-100/50 hover:text-indigo-600 rounded-2xl transition-all duration-200 group {{ request()->routeIs('patients.*') ? 'bg-indigo-50 text-indigo-600' : '' }}">
                        ...
                        <span x-show="!isCollapsed" x-transition.opacity.duration.300ms class="me-2 text-base font-medium whitespace-nowrap">{{ __('سجل المرضى') }}</span>
                    </a>
                    ...
                    <a href="{{ route('appointments.index') }}" class="flex items-center px-3 py-3 text-slate-600 hover:bg-slate-100/50 hover:text-indigo-600 rounded-2xl transition-all duration-200 group {{ request()->routeIs('appointments.*') ? 'bg-indigo-50 text-indigo-600' : '' }}">
                        ...
                        <span x-show="!isCollapsed" x-transition.opacity.duration.300ms class="me-2 text-base font-medium whitespace-nowrap">{{ __('جدول المواعيد') }}</span>
                    </a>
                    ...
                    <a href="{{ route('billing.index') }}" class="flex items-center px-3 py-3 text-slate-600 hover:bg-slate-100/50 hover:text-indigo-600 rounded-2xl transition-all duration-200 group {{ request()->routeIs('billing.*') ? 'bg-indigo-50 text-indigo-600' : '' }}">
                       ...
                       <span x-show="!isCollapsed" x-transition.opacity.duration.300ms class="me-2 text-base font-medium whitespace-nowrap">{{ __('الحسابات') }}</span>
                    </a>
                    @endif
                    ...
                    <a href="{{ route('settings.index') }}" class="flex items-center px-3 py-3 text-slate-600 hover:bg-slate-100/50 hover:text-indigo-600 rounded-2xl transition-all duration-200 group {{ request()->routeIs('settings.*') ? 'bg-indigo-50 text-indigo-600' : '' }}">
                        ...
                        <span x-show="!isCollapsed" x-transition.opacity.duration.300ms class="me-2 text-base font-medium whitespace-nowrap">{{ __('الإعدادات') }}</span>
                    </a>
                    <a href="#" class="flex items-center px-3 py-3 text-slate-600 hover:bg-slate-100/50 hover:text-indigo-600 rounded-2xl transition-all duration-200 group">
                        ...
                        <span x-show="!isCollapsed" x-transition.opacity.duration.300ms class="me-2 text-base font-medium whitespace-nowrap">{{ __('الدعم الفني') }}</span>
                    </a>
                    ...
                    <a href="#" class="flex items-center px-3 py-3 text-slate-600 hover:bg-slate-100/50 hover:text-indigo-600 rounded-2xl transition-all duration-200 group">
                        ...
                        <span x-show="!isCollapsed" x-transition.opacity.duration.300ms class="me-2 text-base font-medium whitespace-nowrap">{{ __('إشعارات النظام') }}</span>
                    </a>
            ...
            <div class="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
                ...
                <header class="h-20 flex items-center justify-between px-6 sm:px-8 mt-4 mx-4 md:mx-6 z-10 flex-shrink-0 bg-white/40 backdrop-blur-md border border-white/20 rounded-3xl">
                    ...
                    <div class="flex items-center" x-data="{ open: false }">
                        ...
                        <!-- Dropdown Menu -->
                        <div x-show="open" @click.away="open = false" x-transition class="absolute top-16 start-6 w-48 bg-white shadow-lg rounded-2xl border border-slate-100 py-2 z-50">
