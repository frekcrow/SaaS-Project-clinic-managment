        ...
        <div class="min-h-screen flex relative overflow-hidden">
            ...
            >
                ...
                <nav class="flex-1 px-3 py-4 space-y-2 overflow-y-auto overflow-x-hidden custom-scrollbar">
                    ...
                    <a href="{{ route('patients.index') }}" class="flex items-center px-3 py-3 text-slate-300 hover:bg-slate-800 hover:text-white rounded-2xl transition-all duration-200 group {{ request()->routeIs('patients.*') ? 'bg-slate-800 text-teal-400' : '' }}">
                    ...
                    <a href="#" class="flex items-center px-3 py-3 text-slate-300 hover:bg-slate-800 hover:text-white rounded-2xl transition-all duration-200 group">
