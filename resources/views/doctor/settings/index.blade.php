<x-doctor-layout>
    ...
    <div class="py-12" dir="rtl">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <!-- About Button & Account Management -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <!-- About Button -->
                <div class="p-6 sm:p-8 bg-white/70 backdrop-blur-md shadow-sm sm:rounded-3xl border border-slate-100 flex items-center justify-center">
