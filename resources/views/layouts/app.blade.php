            ...
            >
                ...
                <nav class="flex-1 px-3 py-4 space-y-2 overflow-y-auto overflow-x-hidden">
                    <a href="{{ route('dashboard') }}" class="flex items-center px-3 py-3 text-slate-600 hover:bg-slate-100/50 hover:text-indigo-600 rounded-2xl transition-all duration-200 group {{ request()->routeIs('dashboard') ? 'bg-indigo-50 text-indigo-600' : '' }}">
                        ...
                        <span x-show="expanded" x-transition.opacity.duration.300ms class="mr-2 text-base font-medium whitespace-nowrap">{{ __('الرئيسية') }}</span>
                    </a>
                    ...
                    <a href="{{ route('patients.index') }}" class="flex items-center px-3 py-3 text-slate-600 hover:bg-slate-100/50 hover:text-indigo-600 rounded-2xl transition-all duration-200 group {{ request()->routeIs('patients.*') ? 'bg-indigo-50 text-indigo-600' : '' }}">
                        ...
                        <span x-show="expanded" x-transition.opacity.duration.300ms class="mr-2 text-base font-medium whitespace-nowrap">{{ __('سجل المرضى') }}</span>
                    </a>
                    ...
                    <a href="{{ route('appointments.index') }}" class="flex items-center px-3 py-3 text-slate-600 hover:bg-slate-100/50 hover:text-indigo-600 rounded-2xl transition-all duration-200 group {{ request()->routeIs('appointments.*') ? 'bg-indigo-50 text-indigo-600' : '' }}">
                        ...
                        <span x-show="expanded" x-transition.opacity.duration.300ms class="mr-2 text-base font-medium whitespace-nowrap">{{ __('جدول المواعيد') }}</span>
                    </a>
                    ...
                    <a href="{{ route('billing.index') }}" class="flex items-center px-3 py-3 text-slate-600 hover:bg-slate-100/50 hover:text-indigo-600 rounded-2xl transition-all duration-200 group {{ request()->routeIs('billing.*') ? 'bg-indigo-50 text-indigo-600' : '' }}">
                        ...
                        <span x-show="expanded" x-transition.opacity.duration.300ms class="mr-2 text-base font-medium whitespace-nowrap">{{ __('الحسابات') }}</span>
                    </a>
                    @endif
                ...
                <header class="h-20 flex items-center justify-between px-6 sm:px-8 mt-4 mx-4 md:mx-6 z-10 flex-shrink-0 bg-white/40 backdrop-blur-md border border-white/20 rounded-3xl">
                    ...
                    <div class="flex-1 flex justify-center px-4" x-data="globalSearch()">
                        <div class="w-full max-w-md relative" @click.away="open = false">
                            ...
                            <input type="text" x-model="query" @input.debounce.300ms="search" @focus="open = true" class="w-full bg-white border-[1.5px] border-black/80 rounded-full shadow-sm py-2.5 pr-11 pl-4 focus:ring-2 focus:ring-indigo-500/50 focus:outline-none text-sm text-slate-700 placeholder-slate-400 transition-shadow" placeholder="ابحث هنا...">
