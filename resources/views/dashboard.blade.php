<x-app-layout>
    ...
    <div class="rounded-3xl shadow-sm dark:shadow-none p-4 flex flex-col h-[calc(100vh-10rem)]">
    ...
    <div class="flex flex-col sm:flex-row items-center justify-between w-full mb-6 gap-4">
        ...
        <div class="flex items-center gap-3 justify-start w-full sm:w-auto">
            ...
            <a href="{{ route('appointments.create') }}" class="w-full sm:w-auto px-6 bg-black text-white shadow-inner rounded-xl p-3 flex items-center justify-center space-x-2 rtl:space-x-reverse transition-colors hover:bg-gray-800">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex items-center justify-end w-full sm:w-auto">
            ...
            <div x-data="queueCapsule"
                 x-init="initCapsule"
                 class="flex items-center justify-center relative overflow-hidden bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-md dark:shadow-none border border-gray-100 dark:border-gray-700 w-full sm:w-56 h-16 min-w-max">
                    ...
                    <div x-show="currentIndex === index"
                        ...
                        <div x-show="state.status === 'active'" class="flex items-center justify-center gap-3 w-fit mx-auto">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-slate-800 dark:text-slate-200 font-bold text-sm tracking-wide truncate">{{ __('المراجع الحالي') }}</span>
                            </div>
                        ...
                        <div x-show="state.status === 'waiting'" class="flex items-center justify-center gap-3 w-fit mx-auto">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-slate-600 dark:text-slate-400 font-bold text-sm tracking-wide truncate">{{ __('المراجع التالي') }}</span>
                            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 mb-4">
        ...
        <div class="lg:col-span-5 bg-white dark:bg-gray-800 shadow-md dark:shadow-none border-transparent rounded-2xl p-4 flex flex-col justify-center">
            <div class="grid grid-cols-2 gap-4 h-full">
                <!-- Live Consultation Status Card -->
                <div class="relative overflow-hidden w-full h-full flex flex-col justify-center border-l border-slate-100 dark:border-gray-700 pl-4"
                     x-data="{
                        timer: 0,
                        formattedTime() {
                    ...
                    <div class="flex flex-col relative z-10">
                        <div class="flex items-center space-x-2 rtl:space-x-reverse mb-2">
                            ...
                            <h2 class="text-sm font-bold text-slate-800 dark:text-slate-200">{{ __('حالة العيادة الآن') }}</h2>
                        </div>
                ...
                <div class="flex flex-col justify-between w-full h-full">
                    <div class="flex items-start justify-between w-full gap-2">
                        <div class="flex-1">
                            ...
                            <p class="text-2xl font-bold text-slate-800 dark:text-slate-200">{{ $visitorsCount }}</p>
                        </div>
                    </div>
                    <form method="GET" action="{{ route('dashboard') }}" class="self-start mt-2 w-full">
                        <select name="filter" onchange="this.form.submit()" class="text-xs border-0 bg-slate-50 dark:bg-gray-900 rounded-lg text-slate-600 dark:text-slate-400 focus:ring-0 cursor-pointer pl-6 pr-2 py-1 w-full text-right bg-[position:left_0.25rem_center]">
        ...
        <div class="lg:col-span-7 bg-white dark:bg-gray-800 shadow-md dark:shadow-none border-transparent rounded-2xl p-4 flex flex-col justify-center">
            <div class="grid grid-cols-3 gap-4 h-full">
                <!-- Card 1: Today's Appointments -->
                <div class="flex flex-col justify-between h-full border-l border-slate-100 dark:border-gray-700 pl-4">
                    ...
                    <p class="text-2xl font-bold text-slate-800 dark:text-slate-200">{{ $todaysAppointments->count() }}</p>
                    <form method="GET" action="{{ route('dashboard') }}" class="mt-2 w-full">
                        ...
                        <select name="appointment_status" onchange="this.form.submit()" class="text-xs border-0 bg-slate-50 dark:bg-gray-900 rounded-lg text-slate-600 dark:text-slate-400 focus:ring-0 cursor-pointer pl-6 pr-2 py-1 w-full text-right bg-[position:left_0.25rem_center]">
                ...
                <div class="flex flex-col justify-between h-full border-l border-slate-100 dark:border-gray-700 pl-4">
                    ...
                    <p class="text-2xl font-bold text-slate-800 dark:text-slate-200">{{ $pendingSurgeries }}</p>
                ...
                <div class="flex flex-col justify-between h-full">
                    ...
                    <p class="text-2xl font-bold text-slate-800 dark:text-slate-200">{{ $todaySessionsCount }}</p>
    ...
    <div class="mb-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-3xl p-6 shadow-sm dark:shadow-none border border-black/5 flex flex-col justify-between hover:shadow-md transition-shadow relative overflow-hidden z-20">
                ...
                <form method="GET" action="{{ route('dashboard') }}" class="self-start flex flex-col items-end gap-2" x-data="{
                    ...
                    <div class="flex items-center gap-2">
                        <div class="relative" x-init="initDatepicker()">
                            ...
                            <input type="text" name="revenue_date" x-ref="dateInput" dir="ltr" class="text-left text-xs border-0 bg-slate-50 dark:bg-gray-900 rounded-lg text-slate-600 dark:text-slate-400 focus:ring-0 cursor-pointer pl-6 pr-2 py-1 w-24" placeholder="{{ __('تاريخ محدد') }}">
                        </div>
                        <select name="revenue_period" onchange="this.form.submit()" class="text-xs border-0 bg-slate-50 dark:bg-gray-900 rounded-lg text-slate-600 dark:text-slate-400 focus:ring-0 cursor-pointer pl-6 pr-2 py-1 w-20 text-right bg-[position:left_0.25rem_center]">
            ...
            <div class="relative z-10 mt-2">
                ...
                <p class="text-3xl font-bold text-slate-800 dark:text-slate-200">{{ number_format($totalRevenue) }} <span class="text-lg text-slate-500 font-normal">{{ __('د.ع') }}</span></p>
            </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-md dark:shadow-none border border-black/5 flex-1 min-h-0 flex flex-col overflow-hidden">
        <div class="p-4 border-b border-black/5 flex items-center justify-between shrink-0">
            <h2 class="text-lg font-bold text-slate-800 dark:text-slate-200">{{ __('مواعيد اليوم') }}</h2>
        ...
        <div class="overflow-y-auto flex-1 min-h-0">
            <table class="w-full text-right">
                <thead>
                    <tr class="bg-slate-50 dark:bg-gray-900 text-slate-500 text-sm">
                ...
                <tbody class="divide-y divide-slate-50">
                    @forelse($recentAppointments as $appointment)
                        <tr class="hover:bg-slate-50/80 transition-colors group">
                            <td class="py-4 px-6 text-slate-800 dark:text-slate-200 font-medium group-hover:text-indigo-600 transition-colors">
    ...
    <div x-data="{
        ...
        <div class="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 bg-white/70 dark:bg-gray-800 backdrop-blur-xl border border-white/60 shadow-lg dark:shadow-none rounded-full px-6 py-3 flex items-center space-x-6 rtl:space-x-reverse transition-transform dark:backdrop-blur-none">

            <button @click="callsModal = true" class="text-slate-600 dark:text-slate-400 hover:text-indigo-600 transition-colors relative group">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="w-px h-6 bg-slate-200 dark:bg-gray-700"></div>

            <button @click="messagesModal = true" class="text-slate-600 dark:text-slate-400 hover:text-indigo-600 transition-colors relative group">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('settings.index') }}" class="text-slate-600 dark:text-slate-400 hover:text-indigo-600 transition-colors">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div x-show="callsModal"
            ...
            <div class="absolute inset-0 overflow-hidden">
                <div x-show="callsModal"
                     ...
                     class="absolute inset-0 bg-slate-900/40 backdrop-blur-sm transition-opacity dark:backdrop-blur-none"
                ...
                <div class="pointer-events-none fixed inset-y-0 left-0 flex max-w-full pr-10">
                    <div x-show="callsModal"
                        ...
                        <div class="flex h-full flex-col overflow-y-scroll bg-white dark:bg-gray-800 py-6 shadow-xl dark:shadow-none rounded-r-3xl border-r border-black/5">
                            <div class="px-4 sm:px-6 flex items-center justify-between">
                                <h2 class="text-lg font-bold text-slate-900 dark:text-slate-100" id="slide-over-title">{{ __('المكالمات الواردة') }}</h2>
                                <button type="button" @click="callsModal = false" class="rounded-md bg-white dark:bg-gray-800 text-slate-400 hover:text-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                            ...
                            <div class="relative mt-6 flex-1 px-4 sm:px-6">
                                <ul class="space-y-4">
                                    @forelse($recentCalls as $call)
                                        <li class="bg-slate-50 dark:bg-gray-900 p-4 rounded-2xl border border-black/5">
                                            <!-- Example of real data rendering -->
                                            <div class="flex items-center justify-between">
                                                <p class="font-medium text-slate-800 dark:text-slate-200">{{ $call->caller_name }}</p>
            ...
            <div class="absolute inset-0 overflow-hidden">
                ...
                <div class="pointer-events-none fixed inset-y-0 start-0 flex max-w-full pe-10">
                    <div x-show="messagesModal"
                         ...
                         class="pointer-events-auto w-screen max-w-md">
                        <div class="flex h-full flex-col bg-white dark:bg-gray-800 shadow-xl dark:shadow-none rounded-e-3xl border-e border-black/5 overflow-hidden">

                            <!-- View A: Conversation List -->
                            <div x-show="currentView === 'list'" class="flex-1 flex flex-col h-full overflow-hidden">
                                <div class="px-4 py-6 sm:px-6 flex items-center justify-between border-b border-slate-100 dark:border-gray-700">
                                    <h2 class="text-lg font-bold text-slate-900 dark:text-slate-100" id="slide-over-title">{{ __('الرسائل') }}</h2>
                                    <button type="button" @click="messagesModal = false" class="rounded-md bg-white dark:bg-gray-800 text-slate-400 hover:text-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                                        <span class="sr-only">Close panel</span>
                                        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                                        </svg>
                                ...
                                <div class="flex-1 overflow-y-auto px-4 py-4 sm:px-6 custom-scrollbar">
                                    <ul class="space-y-4">
                                        @forelse($recentMessages as $conversation)
                                            <li class="bg-slate-50 dark:bg-gray-900 p-4 rounded-2xl border border-black/5 hover:border-indigo-200 transition-colors cursor-pointer" @click="openChat({{ $conversation->id }}, {{ Js::from($conversation->patient ? $conversation->patient->name : ($conversation->contact_name ?: $conversation->provider_chat_id)) }}, {{ Js::from($conversation->platform) }})">
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div class="flex-1 min-w-0">
                                                        <div class="flex justify-between items-center mb-1">
                                                            <h3 class="font-bold text-slate-800 dark:text-slate-200 truncate">
                                                                @if($conversation->patient)
                            ...
                            <!-- View B: Active Chat -->
                            <div x-show="currentView === 'chat'" class="flex-1 flex flex-col h-full overflow-hidden bg-slate-50 dark:bg-gray-900 relative" style="display: none;">
                                <!-- Chat Header -->
                                <div class="px-4 py-4 border-b border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 flex items-center gap-3 shadow-sm dark:shadow-none z-10">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h3 class="font-bold text-slate-800 dark:text-slate-200 truncate" x-text="activeChatName"></h3>
                                        ...
                                        <div>
                                            <template x-if="message.sender_type === 'clinic'">
                                                ...
                                                <div class="flex justify-start">
                                                    <div class="max-w-[85%] bg-indigo-600 text-white rounded-2xl rounded-tr-sm px-4 py-2 shadow-sm dark:shadow-none">
                                            ...
                                            <template x-if="message.sender_type !== 'clinic'">
                                                ...
                                                <div class="flex justify-end">
                                                    <div class="max-w-[85%] bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 text-slate-800 dark:text-slate-200 rounded-2xl rounded-tl-sm px-4 py-2 shadow-sm dark:shadow-none">
                                                        <div class="text-sm" x-text="message.content"></div>
                                                    </div>
                                                </div>
                                            </template>
                                ...
                                <!-- Chat Input -->
                                <div class="p-4 bg-white dark:bg-gray-800 border-t border-slate-200 dark:border-gray-700 z-10">
                                    <form @submit.prevent="sendMessage()" class="flex gap-2 items-end">
                                        <div class="flex-1 bg-slate-50 dark:bg-gray-900 rounded-2xl border border-slate-200 dark:border-gray-700 overflow-hidden focus-within:ring-2 focus-within:ring-indigo-500 focus-within:border-indigo-500 transition-all">
                                            <textarea
                                                x-model="newMessage"
                                                rows="1"
                                                class="w-full bg-transparent border-0 focus:ring-0 dark:bg-gray-900 dark:text-white resize-none py-3 px-4 max-h-32 text-slate-800 dark:text-slate-200"
                                                placeholder="{{ __('اكتب رسالة...') }}"
                                                required
                                                @keydown.enter.prevent="sendMessage()"
                                            ></textarea>
                                        </div>
                                        <button type="submit" class="w-12 h-12 rounded-full bg-indigo-600 text-white flex items-center justify-center hover:bg-indigo-700 transition-colors shadow-sm dark:shadow-none flex-shrink-0" :disabled="isSending" :class="{'opacity-50 cursor-not-allowed': isSending}">
