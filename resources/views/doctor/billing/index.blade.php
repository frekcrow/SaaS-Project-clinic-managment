                ...
                <div class="p-6 border-b border-gray-100 dark:border-gray-700 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gray-50/50 dark:bg-gray-800/50">
                    ...
                    <div>
                        <form method="GET" action="{{ route('doctor.billing.index') }}" x-data="{ sort: '{{ $sortOrder }}' }" class="flex items-center gap-2">
                            ...
                            <select name="sort" id="sort" x-model="sort" @change="$event.target.form.submit()" class="border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 rounded-xl focus:ring-teal-500 focus:border-teal-500 text-sm ps-3 pe-10 py-2 bg-white dark:bg-gray-700 shadow-sm cursor-pointer">
